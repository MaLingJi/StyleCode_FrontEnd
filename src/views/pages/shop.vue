<template>
  <div class="ts-container">
    ...
    <div class="ts-grid is-evenly-divided">
      <div class="column is-center-aligned" v-for="category in categories" :key="category.categoryId">
        <button class="ts-text is-undecorated is-secondary" @click="toggleSubcategories(category)">
          {{ category.categoryName }}
        </button>
        <!-- 只有當 showSubcategories 為 true 時顯示子分類 -->
        <div v-if="category.showSubcategories" class="ts-grid is-evenly-divided">
          <div class="column is-center-aligned">
            <div class="column is-center-aligned" v-for="subcategory in category.subcategories"
