            ...
            <div class="column is-9-wide product-info">
                ...
                <div class="ts-box is-segment has-top-spaced-large">
                    <div class="ts-content">
                        ...
                        <p class="ts-text">{{ selectedDetail ? selectedDetail.productDescription :
...
const nextImage = () => {
    currentImageIndex.value = (currentImageIndex.value + 1) % product.value.pimages.length;
};

const prevImage = () => {
    currentImageIndex.value = (currentImageIndex.value - 1 + product.value.pimages.length) % product.value.pimages.length;
};
